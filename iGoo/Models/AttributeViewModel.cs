...
{
    public class AttributeViewModel:clsCMS_Attributes
    {
        ...
        //Select attribute child by Code
        public DataTable SelectChild()
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_CMS_Attributes_SelectChild]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("CMS_Attributes");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@sCode", SqlDbType.NVarChar, 200, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, Code));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_CMS_Attributes_SelectByCode]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("CMS_Attributes");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("clsCMS_Attributes::SelectByCode::Error occured.", ex);
            }
            finally
            {
                if (_mainConnectionIsCreatedLocal)
        ...
        public DataTable SelectByValue()
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_CMS_Attributes_SelectByValue]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("CMS_Attributes");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@sCode", SqlDbType.NVarChar, 200, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, Code));
                cmdToExecute.Parameters.Add(new SqlParameter("@sValue", SqlDbType.NVarChar, 200, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, Value));
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("clsCMS_Attributes::sp_CMS_Attributes_SelectByValue::Error occured.", ex);
            }
            finally
            {
                if (_mainConnectionIsCreatedLocal)
        ...
        public DataTable SelectPageView()
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_CMS_Attributes_SelectByValue]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("clsCMS_Attributes::sp_CMS_Attributes_SelectPageView::Error occured.", ex);
            }
            finally
            {
                if (_mainConnectionIsCreatedLocal)
