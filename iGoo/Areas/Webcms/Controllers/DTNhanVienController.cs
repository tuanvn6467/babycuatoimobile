...
{
    public class DTNhanVienController : DefaultController
    {
        private String per = Libs.GetPermission("ORDER");

        private List<DataRow> list;

        DTNhanVienViewModel iv = new DTNhanVienViewModel();
        ...
        public ActionResult Index()
        {
            ...
            list = iv.ReportDoanhThu_NhanVien().AsEnumerable().ToList();            
            ViewBag.BaoCao = list;               
        ...
        public void ExportData()
        {
            try
            {
                ...
                string sheetName = "BaoCaoDoanhThu_NV"; //Give name for export file. 
