...
{
    public class XuatKhoNBController : DefaultController
    {
        //
        // GET: /Webcms/InventoryDetail/
        private String per = Libs.GetPermission("XuatKhoNB");
        ...
        public ActionResult Index()
        {
            ...
            List<DataRow> listIvNhap = iv.SelectOptimize().AsEnumerable().ToList();
            ...
            idv.Status = Request.IsNull("slSearchType") ? idv.Status = 1 : idv.Status = Request.GetNumber("slSearchStatus");
            ...
            try
            {
                ...
                for (int i = 1; i <= Request.GetNumber("count"); i++)
                {
                    if (!Request.IsNull("ckID-" + i.ToString()))
                    {
                        ...
                        idv.Description = "Thay đổi số lượng kho bởi chức năng xuất kho nội bộ.";
                            ...
                            //idv.KhoNhap = new Guid(Request.Get("slKhoNhap"));
                                ...
                                if (idv.ChangeType == 0)
                                {
                                    ...
                                    if (idv.BrokenQuantity < idv.BrokenQuantityChange || idv.Quantity < idv.QuantityChange)
                                    {
                                        ...
                                        return Redirect("/Webcms/XuatKhoNB?error=1");
                                    }
                                }
                                idv.Change();                                
                        }
                ...
                return Redirect("/Webcms/XuatKhoNB" + returnUrl + "&result=1");
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                {                    
                    ...
                    else
                    {
                        ...
                        idv.InventoryCodeXuat = (Request.Get("hdfKhoXuat-" + i.ToString()));
                        idv.InventoryCodeNhap = (Request.Get("hdfKhoNhap-" + i.ToString()));
                        ...
                        idv.Description = "Thay đổi số lượng kho bởi chức năng import dữ liệu xuất kho nội bộ.";
                ...
                return Redirect("/Webcms/XuatKhoNB/ImportProduct?result=1&sfalse=" + sfalse);
            }
            catch (Exception ex)
            {
                Libs.WriteError(ex.ToString());
