...
{
    public class ShipperViewModel: clsCMS_Shippers
    {
        public override DataTable SelectAll()
        {
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@FullName", SqlDbType.NVarChar, 200, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, FullName));
