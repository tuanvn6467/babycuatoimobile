...
namespace iGoo.Classes
{
    ...
    public class clsCMS_DTNhanVien : clsDBInteractionBase
    {
        /// <summary>
        /// Purpose: Class constructor.
        /// </summary>
        public clsCMS_DTNhanVien()
        {
            // Nothing for now.
        }
        ...
        public override DataTable SelectOne()
        {
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@ChungLoai", SqlDbType.UniqueIdentifier, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ChungLoai));
        ...
        private SqlGuid _NVGH = SqlGuid.Null;
        public SqlGuid NVGH
        {
            get
            {
        ...
        private SqlGuid _ChiNhanh = SqlGuid.Null;
        public SqlGuid ChiNhanh
        {
            get
            {
                return _ChiNhanh;
        ...
        private SqlInt32 _TypeBuy = SqlInt32.Null;

        public SqlInt32 TypeBuy
        {
            get { return _TypeBuy; }
            set { _TypeBuy = value; }
        }
